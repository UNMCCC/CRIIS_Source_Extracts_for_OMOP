...
SELECT distinct  'Mosaiq Ref_SchSet_Charges(OMOP_PROCEDURE_OCCURRENCE)' AS IDENTITY_CONTEXT
            ...
            ,isNULL(FORMAT(chg.Appt_DtTm,'yyyy-MM-dd 00:00:00'),'')	AS PROCEDURE_DATE  
			...
			,isNULL(chg.days_units,'')		AS QUANTITY  -- 1/20/22 - Need to ask Teri if this is correct
			,isNULL(chg.Chg_Provider_Id,'')	AS PROVIDER_ID
