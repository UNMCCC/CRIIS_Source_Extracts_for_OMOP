...
SELECT 'IDENTITY_CONTEXT','SOURCE_PK'	,'OBSERVATION_PERIOD_ID','PERSON_ID','OBSERVATION_PERIOD_START_DATE','OBSERVATION_PERIOD_END_DATE','PERIOD_TYPE_CONCEPT_ID','modified_DtTm' 
UNION ALL
SELECT 
